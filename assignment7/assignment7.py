...
def findMatchesBetweenImages(image_1, image_2):
  ...
  orb = cv2.ORB()
    ...
    #image_2_kp = orb.detect(image_1, None)
    #image_1_kp, d1 = orb.compute(image_1, image_1_kp)
    #image_2_kp, d2 = orb.compute(image_2, image_2_kp)
  image_1_kp, d1 = orb.detectAndCompute(image_1,None)
  image_2_kp, d2 = orb.detectAndCompute(image_2,None)
